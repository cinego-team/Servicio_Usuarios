...
-- Venta inventada
( '2026-01-03', 9000.00, NULL, 1, 6, '2026-01-10', '20:00' ),

-- Camila compra el 22/12 para función el 01/01
( '2025-12-22', 6400.00, 1, 1, 4, '2026-01-01', '19:30' ),

-- Venta inventada
( '2026-01-05', 15000.00, NULL, 3, 7, '2026-01-15', '22:00' ),

-- María compra el 23/12 pero queda pendiente
( '2025-12-23', 6000.00, NULL, 3, 5, '2026-01-01', '22:00' ),

-- Venta inventada
( '2026-01-08', 11000.00, NULL, 1, 8, '2026-01-20', '21:30' ),

-- Gianella compra el 24/12 y se rechaza
( '2025-12-24', 8000.00, NULL, 2, 3, '2026-01-02', '20:00' ),

-- Venta inventada
( '2026-01-10', 7000.00, NULL, 2, 9, '2026-01-25', '19:00' ),

-- Camila compra el 26/12 para función el 31/12
( '2025-12-26', 16000.00, NULL, 1, 4, '2025-12-31', '23:00' ),

-- Ventas inventadas (enero)
(
    '2026-01-12',
    14000.00,
    2,
